...
// }());
//  var scrollSettings = new ScrollSettings();
...
{ id:'Double Sofaa', shape :{ type: 'Path', data:"M39.3572 42.5001C33.5879 44.3644 23.3389 47.3726 11.0312 42.8982M39.3572 42.5001C38.9901 32.896 39.1315 17.3601 40.2727 11.5C38.1563 12.9176 38.0909 13 33.1818 14C28.8182 14.8889 26.0909 14.5 26.0909 14.5C26.0909 14.5 22.2727 14.5 19 14C15.7273 13.5 14.0909 13 10.2727 10.9155C10.7143 16.2832 11.7887 29.6759 11.0312 42.8982M39.3572 42.5001C39.4226 44.2122 40.7919 45.5708 42.5027 45.6646L45.163 45.8105C47.0566 45.9143 48.6622 44.438 48.7092 42.5421C48.8219 38.0026 49 29.9987 49 24.7736C49 20.1829 48.725 13.4473 48.5055 8.8007C48.3595 5.71097 46.1103 3.14326 43.0526 2.67589C38.2269 1.93827 30.8617 1 24.619 1C18.1203 1 10.557 2.69472 5.86868 3.94263C3.15069 4.66609 1.30579 7.10774 1.22538 9.91921C1.12006 13.6016 1 19.0538 1 24.7736C1 31.5601 1.16901 38.7232 1.28189 42.7504C1.33277 44.5656 2.82066 46 4.63658 46H7.70901C9.46516 46 10.9308 44.6515 11.0312 42.8982M22.2195 21.2201C22.2195 22.1507 21.4652 22.9051 20.5346 22.9051C19.604 22.9051 18.8496 22.1507 18.8496 21.2201C18.8496 20.2895 19.604 19.5352 20.5346 19.5352C21.4652 19.5352 22.2195 20.2895 22.2195 21.2201ZM22.2195 27.9594C22.2195 28.89 21.4652 29.6443 20.5346 29.6443C19.604 29.6443 18.8496 28.89 18.8496 27.9594C18.8496 27.0288 19.604 26.2744 20.5346 26.2744C21.4652 26.2744 22.2195 27.0288 22.2195 27.9594ZM22.2195 34.6986C22.2195 35.6292 21.4652 36.3836 20.5346 36.3836C19.604 36.3836 18.8496 35.6292 18.8496 34.6986C18.8496 33.7681 19.604 33.0137 20.5346 33.0137C21.4652 33.0137 22.2195 33.7681 22.2195 34.6986ZM32.3294 21.2201C32.3294 22.1507 31.575 22.9051 30.6444 22.9051C29.7139 22.9051 28.9595 22.1507 28.9595 21.2201C28.9595 20.2895 29.7139 19.5352 30.6444 19.5352C31.575 19.5352 32.3294 20.2895 32.3294 21.2201ZM32.3294 27.9594C32.3294 28.89 31.575 29.6443 30.6444 29.6443C29.7139 29.6443 28.9595 28.89 28.9595 27.9594C28.9595 27.0288 29.7139 26.2744 30.6444 26.2744C31.575 26.2744 32.3294 27.0288 32.3294 27.9594ZM32.3294 34.6986C32.3294 35.6292 31.575 36.3836 30.6444 36.3836C29.7139 36.3836 28.9595 35.6292 28.9595 34.6986C28.9595 33.7681 29.7139 33.0137 30.6444 33.0137C31.575 33.0137 32.3294 33.7681 32.3294 34.6986Z"}},
...
palettes: [
    ...
    { id: 'connectorSymbols',expanded: true, symbols: connectorSymbols, iconCss: 'e-ddb-icons e-flow', title: 'Connector'}
  ],
...
var getFileMenuItems =[
  ...
  var getInsertMenuItems=[
    { text: 'Insert Picture',tooltipText:'Insert Picture' ,iconCss:'sf-icon-insert_image '},
...
var toolbarNodeInsert = new ej.navigations.Toolbar({
  ...
  items: [
      ...
      { prefixIcon: 'sf-icon-insert_image', tooltipText: 'Insert Image', cssClass: 'tb-item-end' }
  ]
});
...
var orderCommandsitems=[
  { iconCss: 'sf-icon-bring-forward', tooltipText: 'Bring Forward',text:'Bring Forward' },
  { iconCss: 'sf-icon-bring-to-front', tooltipText: 'Bring To Front',text:'Bring To Front' },
  { iconCss: 'sf-icon-send-backward', tooltipText: 'Send Backward' ,text:'Send Backward'},
  { iconCss: 'sf-icon-send-to-back', tooltipText: 'Send To Back' ,text:'Send To Back'},
...
var orderCommands = new ej.splitbuttons.DropDownButton({
 ...
 var connectortypes =[
  { tooltipText: 'Straight', text: 'Straight',iconCss:'sf-icon-straight_line' },
  { tooltipText: 'Orthogonal', text: 'Orthogonal' ,iconCss:'sf-icon-orthogonal_line'},
  { tooltipText: 'Bezier', text: 'Bezier',iconCss:'sf-icon-bezier' },
]
...
// function onOpenUploadSuccess(args) {
//   var file1 = args.file;
...
var fontColorBtn = new ej.buttons.Button({ iconCss: 'sf-icon-fil_colour' });
...
var toolbarTextAlignment = new ej.navigations.Toolbar({
  ...
  items: [
      { prefixIcon: 'sf-icon-align_left', tooltipText: 'Align Right', cssClass: 'tb-item-start' },
      { prefixIcon: 'sf-icon-align_center', tooltipText: 'Align Center', cssClass: 'tb-item-middle' },
      { prefixIcon: 'sf-icon-align_right', tooltipText: 'Align Left', cssClass: 'tb-item-middle' },
      { prefixIcon: 'sf-icon-align_top', tooltipText: 'Align Bottom', cssClass: 'tb-item-middle' },
      { prefixIcon: 'sf-icon-align_middle', tooltipText: 'Align Middle', cssClass: 'tb-item-middle' },
      { prefixIcon: 'sf-icon-align_bottom', tooltipText: 'Align Top', cssClass: 'tb-item-end' }
  ]
});
...
var toolbarEditor = new ej.navigations.Toolbar({
    ...
    items: [
        {
        prefixIcon: 'sf-icon-new', tooltipText: 'New',cssClass: 'tb-item-start'
        },
        {
            prefixIcon: 'sf-icon-save', tooltipText: 'Save',cssClass: 'tb-item-middle' 
        },
        {
          prefixIcon: 'sf-icon-open', tooltipText: 'Open' ,cssClass: 'tb-item-middle' 
        },
        {
            prefixIcon: 'sf-icon-print', tooltipText: 'Print' ,cssClass: 'tb-item-middle' },
        {
            prefixIcon:'sf-icon-export',tooltipText: 'Export',cssClass: 'tb-item-end'},
        {
            type: 'Separator'
        },
        {
            prefixIcon: 'sf-icon-cut', tooltipText: 'Cut',cssClass: 'tb-item-start'},
        {
            prefixIcon: 'sf-icon-copy', tooltipText: 'Copy',cssClass: 'tb-item-middle' },
        {
            prefixIcon: 'sf-icon-paste', tooltipText: 'Paste',cssClass: 'tb-item-end' },
        {
            type: 'Separator' },
        {
            prefixIcon: 'sf-icon-undo', tooltipText: 'Undo',cssClass: 'tb-item-start tb-item-undo'},
        {
            prefixIcon: 'sf-icon-redo', tooltipText: 'Redo', cssClass: 'tb-item-end tb-item-redo'},
        {
            type: 'Separator'
        },
        {
        ...
        {
            prefixIcon: 'sf-icon-text', tooltipText: 'Text Tool', cssClass: 'tb-item-end tb-custom-diagram-disable'
        },
        {
            type: 'Separator'
        },
        {
          prefixIcon: 'sf-icon-lock', tooltipText: 'Lock', cssClass: 'tb-item-start tb-item-lock-category'
        },
        {
          prefixIcon: 'sf-icon-delete', tooltipText: 'Delete',cssClass:  'tb-item-end tb-item-lock-category'
        },
        {
        type: 'Separator'
        },
        {
            prefixIcon: 'sf-icon-fil_colour', mode: 'Palette', tooltipText: 'Fill Color',cssClass: 'tb-item-start tb-item-fill'},
        {
            prefixIcon: 'sf-icon-border_colour', mode: 'Palette', tooltipText: 'Border Color', cssClass: 'tb-item-end tb-item-stroke'
        },
        {
            type: 'Separator'
        },
        {
          prefixIcon: 'sf-icon-group', tooltipText: 'Group', cssClass: 'tb-item-start tb-item-align-category'
      },
      {
          prefixIcon: 'sf-icon-ungroup', tooltipText: 'Ungroup', cssClass: 'tb-item-end tb-item-ungroup'
      },
      {
          type: 'Separator'
      },
