...
palettes: [
    ...
    getNodeDefaults: function (node) {
        ...
        else if( node.id === 'Door close' || node.id === 'Double door close')
        {
          node.width = 10;
          node.height = 10;
        }
        else if(node.id === 'Rectangular Table for Two'  ||  node.id === 'Rectangle Study Table'  || node.id === 'Rectangle Study Table1' || node.id === 'Rectangle Study Table2'  ){
          node.width = 60;
          node.height = 40;
        }
        else if(node.id === 'Small Gas Range'  ||  node.id === 'Large Gas Range'  || node.id === 'Large Gas Range1' ){
          node.width = 100;
          node.height = 40;
        }
        else if(node.id ==='Oblong Dining Table'){
          node.width = 80;
          node.height = 60;
        }
        ...
        else if( node.id === 'Book Case' || node.id === 'Warddrobe' || node.id === 'Warddrobe1' || node.id === 'Matte' || node.id === 'Matte1' ){
          node.width = 40;
          node.height = 20;
        }
        else if( node.id === 'Large Plant'|| node.id ==='Small Plant' || node.id === 'Lamp light' || node.id === 'Laptop' ||node.id ==='Printer' ){
          node.width = 25;
          node.height = 25;
        }
        else if(node.id === 'Sofa' || node.id === 'Single Sofa' || node.id === 'Double Sofa' || node.id === 'Sofaa' || node.id === 'Double Sofaa' ||node.id === 'Window Garden' || node.id === 'Staircase' || node.id === 'Staircase1' ||  node.id === 'Staircase2' || node.id === 'Book Case' || node.id === 'Warddrobe' || node.id === 'Warddrobe1' || node.id === 'Matte' || node.id === 'Matte1'){
          node.width = 100;
          node.height = 50;
        }
        else if(node.id === 'Wash Basin1' ||node.id === 'Wash Basin2' || node.id === 'Wash Basin3'|| node.id === 'Wash Basin5' || node.id === 'Wash Basin6' || node.id === 'Double Sink4' || node.id === 'Double Sink'|| node.id === 'Double Sink1' || node.id === 'Double Sink2' ||node.id === 'Bath Tub' || node.id === 'Bath Tub1' || node.id === 'Bath Tub2' || node.id === 'Bath Tub3' || node.id === 'Bath Tub4'){
          node.width = 50;
          node.height = 30;
        }
        else {
...
var pagePortrait = new ej.buttons.Button({
  ...
  // onclick: function (args) {pageOrientationChange(args); },
...
function aspectRatioClick(args)
    {
    var isAspect = true;
    if(document.getElementById('aspectRatioBtn').classList.contains('e-active'))
    {
      ...
      nodePropertyChange({propertyName: 'aspectRatio', propertyValue: isAspect}); 
    };
...
//   items: orderCommandsitems , iconCss: 'sf-icon-bring-forward',select:toolbarEditorClick
//  })
 var connectortypes =[
...
var connectortype = new ej.splitbuttons.DropDownButton({
  items: connectortypes,iconCss: 'sf-icon-orthogonal_line',select:toolbarEditorClick
 })
...
function toolbarInsertClick(args) {
  var commandType = args.target.id.toLowerCase();
  if (diagram.selectedItems.nodes.length > 0) {
      switch (commandType.toLowerCase()) {
          case 'insertlink':
    ...
    switch (commandType) {
        ...
        case 'fontcolor':
              if (diagram.selectedItems.nodes[0].annotations) {
                showColorPicker('textColor', 'tb-item-stroke');
