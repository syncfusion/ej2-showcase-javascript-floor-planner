...
var doors = [
  { id: 'Door close',addInfo:'Door close', shape: { type: 'Path', data: 'M1 71L1 79L72 79V71M1 71L72 71M1 71C1 32.3401 32.3401 1 71 1H72V71' }},  
  { id: 'Double door close',addInfo:'Double door close', shape: { type: 'Path', data:"M143 71V79L1 79L1 71M143 71L1 71M143 71V1H142C103.34 1 72 32.3401 72 71M143 71H72M1 71L1 1H2C40.6599 1 72 32.3401 72 71M1 71L72 71M72 78.5V71"}},
  { id:'Room',addInfo:'Room', shape :{ type: 'Path', data:"M4 4H104V104H4V4Z"}},
  { id:'T Room',addInfo:'T Room', shape :{ type: 'Path', data:"M4 4H273V145.749H192.981V250H71.25V110.312H4V4Z"}},
  { id:'L Room',addInfo:'L Room', shape :{ type: 'Path', data:"M4 4H273V250H146.5V110.312H4V4Z"}},
  { id:'Wall Corner',addInfo:'Wall Corner', shape :{ type: 'Path', data:"M104 4H4V104"}},
  { id:'Wall Corner1',addInfo:'Wall Corner', shape :{ type: 'Path',data:'M0 100L100 100L100 0'}},
  ...
  { id:'T Wall',addInfo:'T Wall', shape :{ type: 'Path', data:"M106 4.00002L206 4.00004M106 4.00002L106 104M106 4.00002L0 4"}},
  
  { id:'Window Garden',addInfo:'Window Garden',dragSize:{width:76,height:29}, shape :{ type: 'Path', data:"M1.5 0H0V1.5V38.5H3V3H152V38.5H155V1.5V0H153.5H1.5ZM6.5 5H5V6.5V38.5H8V8H53V38.5H56V8H100V38.5H103V8H147V38.5H150V6.5V5H148.5H103H101.5H100H56H54.5H53H6.5Z"}},
...
{ id:'Flat TV',addInfo:'Flat TV',dragSize:{width:66,height:13}, shape :{ type: 'Path', data:'M1 15H92M1 15V20H92V15M1 15V10H92V15M79 7L85 1M79 20L85 26M14 7L8 1M14 20L8 26M37 2V7M39 2V7M41 2V7M43 2V7M45 2V7M47 2V7M49 2V7M51 2V7M53 2V7M55 2V7M23 2H70L76 7H17L23 2ZM5 7H88V10H5V7Z'}},
{ id:'Flat TV1',addInfo:'Flat TV',dragSize:{width:66,height:13}, shape :{ type: 'Path', data:'M1 14H92M1 14V19H92V14M1 14V9H92V14M37 1V6M39 1V6M41 1V6M43 1V6M45 1V6M47 1V6M49 1V6M51 1V6M53 1V6M55 1V6M23 1H70L76 6H17L23 1ZM5 6H88V9H5V6Z'}},
...
{  id:'Double Sofa',addInfo:'Double Sofa',dragSize:{width:76,height:35}, shape :{ type: 'Path', data:'M55 17H20C18.3431 17 17 18.3431 17 20V46C17 47.6569 18.3431 49 20 49H55M55 17V49M55 17H91C92.6569 17 94 18.3431 94 20V46C94 47.6569 92.6569 49 91 49H55M106 17H98C95.7909 17 94 18.7909 94 21V45C94 47.2091 95.7909 49 98 49H106C108.209 49 110 47.2091 110 45V21C110 18.7909 108.209 17 106 17ZM106 17H5M106 17C108.209 17 110 15.2091 110 13V5.00001C110 2.79087 108.209 1.00001 106 1.00001L5 1C2.79086 1 1 2.79086 1 5L1 13C1 15.2091 2.79086 17 5 17M5 17H13C15.2091 17 17 18.7909 17 21V45C17 47.2091 15.2091 49 13 49H5C2.79086 49 1 47.2091 1 45L1 21C1 18.7909 2.79086 17 5 17Z'}},
{  id:'Single Sofa',addInfo:'Single Sofa',dragSize:{width:50,height:35}, shape :{ type: 'Path', data:'M67 17L59 17C56.7909 17 55 18.7909 55 21V45C55 47.2091 56.7909 49 59 49H67C69.2091 49 71 47.2091 71 45V21C71 18.7909 69.2091 17 67 17ZM67 17L5 17M67 17C69.2091 17 71 15.2091 71 13V5.00001C71 2.79087 69.2091 1.00001 67 1.00001L5 1C2.79086 1 1 2.79086 1 5L1 13C1 15.2091 2.79086 17 5 17M5 17L13 17C15.2091 17 17 18.7909 17 21V45C17 47.2091 15.2091 49 13 49H5C2.79086 49 1 47.2091 1 45L1 21C1 18.7909 2.79086 17 5 17ZM20 49H52C53.6569 49 55 47.6569 55 46V20C55 18.3431 53.6569 17 52 17H20C18.3431 17 17 18.3431 17 20V46C17 47.6569 18.3431 49 20 49Z'}},
...
palettes: [
    ...
    getNodeDefaults: function (node) {
      ...
      else if(node.id ==='Rectangle Dining Table'){
        node.width = 30;
        node.height = 30;
      }
      ...
      else if(node.id === 'Rectangular Table for Two'){
        node.width = 26;
        node.height = 30;
      }
      else if(node.id === 'Rectangle Study Table'  || node.id === 'Rectangle Study Table1' )
      {
        node.width = 35;
        node.height = 22;
      }
      ...
      else if(node.id ==='L Room' || node.id ==='Wall Corner1'){
        node.width = 45;
        node.height =40;
      }
      else if(node.id ==='T Wall'){
        node.width = 45;
        node.height = 30;
      }
      else if(node.id ==='Room' || node.id ==='T Room'  || node.id ==='Wall Corner'||  node.id ==='Elevator')
      {
        node.width = 45;
        node.height =38;
      }
      ...
      else if(node.id === 'Corner Shower'|| node.id === 'Shower'){
        node.width = 36; 
        node.height = 35;
      }
      else if(node.id === 'Wash Basin1'){
        node.width = 25;
        node.height = 25;
      }
      else if(node.id === 'Wash Basin2' || node.id === 'Wash Basin3'|| node.id === 'Wash Basin5' || node.id === 'Wash Basin6'){
        node.width = 30; 
        node.height = 22;
      }
      else if(node.id === 'Double Sink4' || node.id === 'Double Sink'|| node.id === 'Double Sink1' || node.id === 'Double Sink2'){
        node.width = 50; 
        node.height = 22;
      }
      else if(node.id === 'Refrigerator'|| node.id === 'Water Cooler' )
